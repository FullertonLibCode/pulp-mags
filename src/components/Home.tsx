    ...
    <div className="relative">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            Welcome to a unique exhibition where the past visions of the future meet the analytic gaze of artifical intelligence. This collection showcases classic science fiction pulp magazines covers depicting robots, with commentary generated by an AI curator reflecting on its imagined ancestors in the human imagination.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
