  ...
  useEffect(() => {
    if ('requestIdleCallback' in window) {
      requestIdleCallback(() => {
        ...
        preloadLink.href = '/src/components/ExhibitionGuide.tsx';
    ...
    <div className="relative">
      ...
      >
        <div className="absolute inset-0">
          ...
          {[...Array(iconCount)].map((_, i) => (
            ...
            >
              {i % 3 === 0 ? (
                <BrainCircuit className="text-[#00eeff] w-full h-full" />
              ) : i % 3 === 1 ? (
                <Circuit className="text-[#00eeff] w-full h-full" />
              ) : (
                <Cpu className="text-[#00eeff] w-full h-full" />
              )}
            </motion.div>
          ))}
        ...
        <div className="relative z-10 text-center px-4 w-full max-w-4xl mx-auto">
          ...
          >
            Welcome to a unique exhibition where the past visions of the future meet the gaze of artificial intelligence. This collection showcases classic robot-themed pulp magazine covers with commentary generated by an AI curator reflecting on its own imagined origins in the human imagination.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#00eeff] text-[#0a1128] font-semibold px-8 py-4 rounded-md hover:bg-[#00bfcc] transition-colors duration-300 hover:shadow-[0_0_20px_rgba(0,238,255,0.5)] touch-action-manipulation w-full sm:w-auto"
            ...
            <Link 
              to="/gallery"
              className="inline-block bg-transparent text-[#00eeff] font-semibold px-8 py-4 rounded-md hover:bg-[#00eeff]/10 transition-colors duration-300 border-2 border-[#00eeff] touch-action-manipulation w-full sm:w-auto"
              style={{ contain: 'content' }}
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div 
            className="relative bg-[#132347] rounded-lg overflow-hidden border border-[#1e3a8a]"
            style={{ 
              aspectRatio: '16/9',
              contain: 'strict',
            }}
          >
            <iframe 
              ...
              allowFullScreen
              loading="lazy"
              title="Kestral Introduction - Meet your AI curator for the Dreaming in Metal exhibition"
