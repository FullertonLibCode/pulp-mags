    ...
    <div className="relative">
      ...
      >
        ...
        <div className="relative z-10 text-center px-4">
          ...
          >
            Welcome to a unique exhibition where the past visions of the future meet the gaze of artifical intelligence. This collection presents classic sci-fi pulp magazines covers depicting robots, with commentary generated by an AI curator reflecting on its own imagined ancestry in the human imagination.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          {[
            {
              ...
              title: "AI Reflection",
              description: "Explore curated commentary generated by artificial intelligence reflecting on how robots were depicted in pulp magazine art.",
            ...
            },
            {
              ...
              description: "Explore the design elements of each cover -- robot forms, human interactions, visual cues -- that reveal deeper themes in the visual storytelling of pulp science fiction.",
