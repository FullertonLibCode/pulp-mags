        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative aspect-video bg-[#132347] rounded-lg overflow-hidden border border-[#1e3a8a] group cursor-pointer">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6">
              <h2 className="text-2xl font-bold text-white mb-2">Meet the Kestral, AI Curator</h2>
      ...
      >
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            >
              <div className="relative bg-gradient-to-b from-[#132347]/90 to-[#132347] p-8 border border-[#1e3a8a] group-hover:border-[#00eeff] transition-all duration-300 group-hover:transform group-hover:scale-[1.02]">
                {feature.icon}
                <h2 className="text-2xl font-bold mb-3 font-heading text-white">{feature.title}</h2>
                <p className="text-gray-300">{feature.description}</p>
                <div className="mt-4 text-[#00eeff] font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  Explore Section →
                </div>
              </div>
            </motion.div>
