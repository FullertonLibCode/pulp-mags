...
export const covers: Cover[] = [
  {
    ...
    analysis: {
      ...
      SettingTone: "The setting is a desolate landscape with fiery hues in the background, suggesting a post-apocalyptic or dystopian environment. The emotional tone is tense and dramatic, with the central figure appearing powerful and the surrounding robotic figures suggesting a sense of urgency or danger.",
